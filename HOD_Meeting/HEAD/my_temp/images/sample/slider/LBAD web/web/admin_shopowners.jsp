<%-- 
    Document   : admin_shopowners
    Created on : Sep 15, 2018, 10:29:15 AM
    Author     : Amarnath s p
--%>
...
<html>
    ...
    <h1>shop</h1><table width="100%" border="5">
        ...
        <tr>
            ...
            <td><span><a href='admin_reject_shop.jsp?id=<%=rs.getString("shop_id")%>'><button>Decline</button></a></span></td>
            <td><span><a href="admin_accept_shop.jsp?id=<%=rs.getString("shop_id")%>">Accept</a></span></td>     
            <%}%>
